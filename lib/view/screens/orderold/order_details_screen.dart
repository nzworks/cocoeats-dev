...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  void _loadData(BuildContext context) async {
    ...
    await orderProvider.trackOrder(widget.orderId.toString(), orderModel: widget.orderModel,fromTracking: false, phoneNumber: widget.phoneNumber);
    if(widget.orderModel == null && context.mounted) {
      await splashProvider.initConfig(context);
    }
    await locationProvider.initAddressList();
    await orderProvider.getOrderDetails(widget.orderId.toString(), phoneNumber: widget.phoneNumber);
  }
