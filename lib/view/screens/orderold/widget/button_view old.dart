        ...
        return Column(children: [
          !order.showCancelled ? Center(
            child: SizedBox(
              ...
              child: Row(children: [
                order.trackModel!.orderStatus == 'pending' && phoneNumber != null ? Expanded(child: Padding(
            ...
            child: Container(
              ...
              child: CustomButton(
                ...
                onTap: () =>  RouterHelper.getOrderTrackingRoute(
                  order.trackModel!.id, phoneNumber: phoneNumber,
                ),
              ),
            ),
          ) : const SizedBox(),

          order.trackModel!.orderStatus == 'delivered' && !order.trackModel!.isGuest! && phoneNumber == null &&   order.trackModel!.orderType != 'pos' ? Center(
            child: Container(
              width: width > 700 ? 700 : width,
              padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
              child: CustomButton(
                ...
                onTap: () {
                  ...
                  RouterHelper.getRateReviewRoute(orderId: order.trackModel?.id);
                },
              ),
            ),
          ) : const SizedBox(),
