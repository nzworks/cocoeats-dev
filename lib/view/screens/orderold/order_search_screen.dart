    ...
    return Scaffold(
      ...
      body: CustomScrollView(slivers: [
        ...
        SliverToBoxAdapter(child: Container(
          margin: ResponsiveHelper.isDesktop(context) ? EdgeInsets.symmetric(horizontal: (MediaQuery.of(context).size.width - Dimensions.webScreenWidth) / 2) : null,
        ...
        if(ResponsiveHelper.isDesktop(context))   SliverFillRemaining(
          hasScrollBody: false,
