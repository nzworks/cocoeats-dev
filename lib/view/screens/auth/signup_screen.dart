                                            ...
                                            authProvider.checkEmail(email).then((value) async {
                                              if (value.isSuccess) {
                                                ...
                                                if (value.message == 'active') {
                                                   RouterHelper.getVerifyRoute('sign-up', email);
                                                } else {
                                                   RouterHelper.getCreateAccountRoute(email);
                                                }
                                              }
                                            });
                                          ...
                                          if (numberChk.isEmpty) {
                                            ...
                                            authProvider.checkPhone(number).then((value) async {
                                              if (value.isSuccess) {
                                                ...
                                                if (value.message == 'active') {
                                                   RouterHelper.getVerifyRoute('sign-up', number);
                                                } else {
                                                   RouterHelper.getCreateAccountRoute(number);
                                                }
                                              }
                                            });
